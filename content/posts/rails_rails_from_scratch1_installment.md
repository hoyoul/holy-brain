...
_etc/nginx/site-available_ 에서 작성한 설정을 _etc/nginx/site-enabled_ 에 link걸어서 사용한다. 아파치에서 사용하는 방식이다. 즉 server에 대한 설정을 available에서 하고, link걸어서 적용시킨다. 근데 나는 별 상관하지 않았다.
